    ...
    return (
        <Grid container className={classes.root}>
            ...
            <Grid item xs={12} className={classes.about}>
                <Typography variant="h3" className={classes.h3}>Hi, I'm <span>Fiona Ochs</span>, a Full Stack Software Engineer, with a background in Neurobiology. I enjoy figuring out how things work and the processes involved, and I apply this curiousty towards my love of coding. <br/><br/>
                Striving to produce clean, testable and maintainable code. Interested in the data manipulation and logic driven side of back-end, while also a lover of React, clean UI, and converting information to concise data visualizations.<br/><br/>
